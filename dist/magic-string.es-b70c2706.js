import { c as U } from "./Title.test-92628de2.js";
var O = { exports: {} };
(function(p, t) {
  (function(e, n) {
    n(t);
  })(U, function(e) {
    const n = ",".charCodeAt(0), i = ";".charCodeAt(0), r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", o = new Uint8Array(64), h = new Uint8Array(128);
    ...
    function T(u) {
      ...
      for (let f = 0; f < u.length; f++) {
        const y = u[f];
        if (f > 0 && (a === g && (b += s.decode(d), a = 0), d[a++] = i), y.length !== 0) {
          l[0] = 0;
          for (let C = 0; C < y.length; C++) {
            const v = y[C];
            a > w && (b += s.decode(m), d.copyWithin(0, w, a), a -= w), C > 0 && (d[a++] = n), a = k(d, a, l, v, 0), v.length !== 1 && (a = k(d, a, l, v, 1), a = k(d, a, l, v, 2), a = k(d, a, l, v, 3), v.length !== 4 && (a = k(d, a, l, v, 4)));
          }
        }
      }
